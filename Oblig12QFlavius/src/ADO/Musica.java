...
public class Musica extends Articulo {
    ...
    public static float suplemento = 2f;
    ...
    public Musica(int nPistas, float duracion, String tipo, String nombre, Date fecha, int anyo, String resumen, Autor autor, boolean deteriorado) {
        super("MUS" + contCod, nombre, fecha, anyo, resumen, autor, deteriorado);
